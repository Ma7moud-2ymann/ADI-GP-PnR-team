# 🧩 PULPissimo ASIC Flow — From Synthesis to Final GDSII   <!-- H1 (largest) -->

This repository contains the complete implementation flow for the PULPissimo microcontroller, from RTL synthesis to final GDSII layout. 
