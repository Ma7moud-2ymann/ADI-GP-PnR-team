...
This project aims to demonstrate the full ASIC implementation flow for the open-source PULPissimo SoC platform.
The process follows a standard RTL-to-GDSII design methodology using Synopsys EDA tools, ensuring optimized PPA (Power, Performance, and Area) and functional correctness through all stages.
